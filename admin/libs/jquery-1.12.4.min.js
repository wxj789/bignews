...
//   var loginURL = baseURL + '/admin/user/login'; // 用户登录
//   var user_info = baseURL + '/admin/user/info'; // 获取用户信息

//   // 这些变量都是函数内部的变量，外部要用需要暴露出去
//   // 随意添加全局变量会造成全局污染 改成 window下的全局变量  过多时可能出现重名后面会把前面的覆盖掉
//   // 解决：
//   var bigNews = {
//       baseURL: baseURL,
//       loginURL: loginURL,
